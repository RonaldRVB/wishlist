        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                ...
                <div class="flex gap-4">
                    ...
                    <button @click="router.visit(route('wishlists.index'))"
                        class="bg-blue-600 text-white font-semibold px-4 py-2 rounded-xl hover:bg-blue-700">
                        Retour à mes listes
                    </button>
                </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <div v-for="gift in gifts" :key="gift.id"
                    ...
                    <a v-if="gift.purchase_url" :href="gift.purchase_url" target="_blank"
                        class="text-white bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded-full text-sm mb-2">
                        Voir le produit
                    </a>

                    <div v-if="gift.is_reserved"
            ...
            <!-- Événements liés -->
            <div v-if="wishlist.title !== 'Ma liste personnelle'"
                ...
                <div class="space-y-2">
                    <div v-for="event in userEvents" :key="event.id" class="flex items-center space-x-2">
                        <input type="checkbox" :id="'event-' + event.id" :checked="wishlist.events.some((e) => e.id === event.id)
                            " @change="
