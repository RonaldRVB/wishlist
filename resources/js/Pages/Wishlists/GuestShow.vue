...
<template>
    <div class="min-h-screen bg-[#D6E9FC] py-10 px-4">
        <div class="max-w-5xl mx-auto">
            ...
            >
                <h1
                    class="text-3xl font-bold text-blue-900 text-center sm:text-left"
                >
                ...
                <div
                    v-if="isGuest"
                    class="mt-4 sm:mt-0 flex justify-center sm:justify-end"
                >
                    <button
                        @click="logout"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                ...
                >
                    ...
                    />
                    <h2
                        class="text-lg font-bold text-blue-900 text-center mb-2"
                    >
                        {{ gift.name }}
                    </h2>
