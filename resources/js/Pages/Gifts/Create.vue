        ...
        >
            ...
            <form @submit.prevent="submit" class="space-y-4">
                <div>
                    ...
                    <div
                        v-if="form.errors.wishlist_id"
                        class="text-red-600 text-sm"
                    >
                        {{ form.errors.wishlist_id }}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <img
                        v-if="previewUrl"
                        :src="previewUrl"
                        class="w-32 h-32 object-cover rounded-xl mt-2"
                    />
                </div>

                <div>
                    <label class="block text-sm font-bold text-blue-900 mb-1"
                        >Lien d’achat (facultatif)</label
                    >
                    <input
                        type="url"
                    ...
                    />
                    <div
                        v-if="form.errors.purchase_url"
                        class="text-red-600 text-sm"
                    >
                        {{ form.errors.purchase_url }}
                    </div>
                </div>
