        ...
        <table class="w-full table-auto text-left">
          <thead class="bg-teal-200 text-black">
            <tr>
              ...
              <th class="px-4 py-2">Wishlist</th>
              <th class="px-4 py-2">Événements liés</th>
          ...
          <tbody>
            <tr v-for="gift in gifts" :key="gift.id" class="border-t border-green-500">
              ...
              <td class="px-4 py-2 italic text-gray-600">
                <div v-for="wishlist in gift.wishlists" :key="'e-' + wishlist.id">
              ...
              <td class="px-4 py-2 text-right space-x-2">
                <!-- Voir -->
                <button
                  @click="router.visit(route('gifts.show', gift.id))"
                ...
                <!-- Modifier -->
                <button
                  @click="router.visit(route('gifts.edit', gift.id))"
