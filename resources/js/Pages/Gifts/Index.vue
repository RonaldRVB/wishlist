...
<template>
    ...
    <div class="w-full min-h-screen bg-[#D6E9FC] py-10 px-6 flex flex-col items-center">
            ...
            <div class="bg-[#E3EFFD] shadow rounded-xl mx-auto overflow-hidden w-full">
                <table class="w-full table-auto">
                    ...
                    <tbody class="text-center">
                        <tr v-for="gift in gifts" :key="gift.id" class="border-t border-green-500 align-middle">
                            ...
                            <td class="px-4 py-2">
                                <div v-for="wishlist in gift.wishlists" :key="wishlist.id"
                            ...
                            <td class="px-4 py-2 text-center space-x-2">
                                ...
                                <button @click="
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor"
                                        viewBox="0 0 24 24">
                                        <path d="M3 17.25V21h3.75l11.065-11.065-3.75-3.75L3 17.25zM21.41
                            ...
                            0l-1.83 1.83 3.75 3.75 1.84-1.83z" />
                                ...
                                <!-- Supprimer -->
                                <button @click="openDeleteModal(gift)" class="text-blue-700 hover:text-red-600">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor"
                                        viewBox="0 0 24 24">
                                        <path
        ...
        <!-- Modal suppression -->
        <ModalDelete :show="showDeleteModal" :entity="giftToDelete" routeName="gifts.destroy" labelKey="name"
