...
<template>
    ...
    <div
        class="relative min-h-screen bg-cover bg-center text-blue-900"
    ...
    >
        ...
        <!-- Contenu -->
        <div
            class="min-h-screen backdrop-blur-sm bg-white/60 px-4 py-24 flex flex-col items-center"
        >
            <!-- Message d'erreur -->
            <div
                v-if="flash.error"
            ...
            <!-- Bloc formulaire -->
            <div
                class="w-full max-w-xl bg-[#E3EFFD] rounded-xl shadow-xl border-[6px] border-[#a7befe] p-6"
            >
