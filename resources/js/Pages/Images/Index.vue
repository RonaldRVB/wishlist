...
function deleteImage() {
    if (imageToDelete.value) {
        router.delete(
            route("images.destroy", { defaultImage: imageToDelete.value.id })
        );
...
<template>
    ...
    >
        ...
        <div class="mb-6">
            <button
                @click="router.visit(route('images.create'))"
            ...
            >
                ...
                <tbody>
                    <tr
                        ...
                        :key="image.id"
                        class="border-t border-green-500 text-center"
                    >
                            ...
                            >
                                ...
                                >
                                    <svg
                                        ...
                                        class="w-5 h-5 text-blue-700 hover:text-[#F87171]"
                                        fill="currentColor"
                                        viewBox="0 0 24 24"
                                    >
                                        <path
        ...
        <ModalDelete
            ...
            :entity="imageToDelete"
            routeName="images.destroy"
            labelKey="label"
        ...
        >
            <div
                class="bg-[#D6E9FC] text-blue-900 p-6 rounded-xl shadow-xl max-w-md w-full"
            >
                <h2 class="text-lg p-3 bg-indigo-200 rounded-xl font-bold mb-4">
                    Confirmer la suppression
                </h2>
                <p class="text-blue-900 font-bold mb-6">
                    Es-tu sûr de vouloir supprimer l’image :<br /><br />
                    <strong class="text-2xl font-bold"
                        >{{ imageToDelete?.label }} ?</strong
                    ><br /><br />
                    Cette action est
                    <span class="text-lg italic text-red-400 font-bold"
                        >irréversible</span
                    >.
                </p>
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button
                        @click="deleteImage"
                        class="px-4 py-2 bg-red-400 text-white rounded hover:bg-red-700"
                    >
                        Supprimer
                    </button>
                </div>
