...
<template>
    ...
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <div
            class="bg-white/60 backdrop-blur-md rounded-xl shadow-lg p-6 border border-blue-300 max-w-3xl mx-auto my-12"
        >
            <h2 class="text-2xl font-bold text-blue-900 mb-4">
                🎲 Tirage au sort sans compte
            </h2>
            <p class="text-gray-700 mb-4">
                Cette fonctionnalité te permet de faire un tirage au sort
                simple, sans compte, pour organiser un échange de cadeaux (type
                Secret Santa). Saisis quelques prénoms, clique sur
                <strong>"Lancer le tirage"</strong> et découvre qui offre un
                cadeau à qui !
            </p>
            <div class="flex justify-end">
                <button
                    @click="router.visit(route('draw.index'))"
                    class="bg-indigo-600 text-white font-semibold px-4 py-2 rounded-xl hover:bg-indigo-700 transition"
                >
                    Accéder au tirage
                </button>
            </div>
