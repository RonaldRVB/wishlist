...
<template>
    <div
        class="w-full min-h-screen bg-[#D6E9FC] py-3 px-6 flex flex-col items-center"
    >
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-4 py-2">
                                <div
                                    class="group relative w-16 h-16 overflow-hidden rounded-xl shadow"
                                >
                                    <img
                                        :src="
                                            '/storage/' +
                            ...
                            <td
                                class="px-4 py-2 font-bold italic text-gray-600"
                            >
                                {{ event.slug }}
                            </td>
                            <td
                                class="px-4 py-2 h-16 pt-6 flex items-center justify-start space-x-2"
                            >
                                <button
                                    @click="
                                        router.visit(
                                    ...
                                    "
                                    class="text-blue-700 hover:text-teal-900"
                                    title="Voir"
                                >
                                    <svg
        ...
        <ModalDelete
            ...
            :entity="eventToDelete"
            routeName="events.destroy"
            labelKey="title"
