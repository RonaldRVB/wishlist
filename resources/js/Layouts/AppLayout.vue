...
<template>
    <div class="relative h-screen overflow-hidden">
        ...
        <div v-if="isSidebarOpen" class="fixed inset-0 bg-black/30 backdrop-blur-sm z-40 md:hidden"
        ...
        <aside :class="[
            ...
            <!-- Logo -->
            <div class="mb-6">
                <img src="/storage/images/favicon.ico" alt="Logo" class="block mt-6 ml-3 h-12 w-auto cursor-pointer"
